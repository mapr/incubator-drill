...
import org.apache.drill.exec.store.maprdb.HBaseScanSpec;
...
public class TestHBaseRegionScanAssignments extends BaseHBaseTest {
  ...
  public void testHBaseGroupScanAssignmentMix() throws Exception {
    ...
    MapRDBGroupScan scan = new MapRDBGroupScan();
  ...
  private void testParallelizationWidth(MapRDBGroupScan scan, int i) {
    try {
