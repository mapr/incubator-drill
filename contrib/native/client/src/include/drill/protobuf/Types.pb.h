...
PROTOBUF_NAMESPACE_OPEN
template <>
::common::MajorType* Arena::CreateMaybeMessage<::common::MajorType>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& MinorType_Name(MinorType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<MinorType_descriptor,
                                                 0, 44>(
...
inline const std::string& DataMode_Name(DataMode value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<DataMode_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
...
class MajorType final :
 ...
 public:
  ...
  ~MajorType() override;
  explicit PROTOBUF_CONSTEXPR MajorType(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MajorType* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline void MajorType::set_sub_type(int index, ::common::MinorType value) {
  assert(::common::MinorType_IsValid(value));
  _impl_.sub_type_.Set(index, value);
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& MajorType::sub_type() const {
  // @@protoc_insertion_point(field_list:common.MajorType.sub_type)
  return _impl_.sub_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* MajorType::mutable_sub_type() {
...
inline ::common::MinorType MajorType::_internal_sub_type(int index) const {
  return static_cast<::common::MinorType>(_impl_.sub_type_.Get(index));
}
inline void MajorType::_internal_add_sub_type(::common::MinorType value) {
  assert(::common::MinorType_IsValid(value));
  _impl_.sub_type_.Add(value);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* MajorType::_internal_mutable_sub_type() {
  return &_impl_.sub_type_;
}
