...
PROTOBUF_NAMESPACE_OPEN
template <>
::exec::DrillServiceInstance* Arena::CreateMaybeMessage<::exec::DrillServiceInstance>(Arena*);
template <>
::exec::DrillbitEndpoint* Arena::CreateMaybeMessage<::exec::DrillbitEndpoint>(Arena*);
template <>
::exec::Roles* Arena::CreateMaybeMessage<::exec::Roles>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& DrillbitEndpoint_State_Name(DrillbitEndpoint_State value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<DrillbitEndpoint_State_descriptor,
                                                 0, 3>(
