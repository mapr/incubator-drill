...
class PlanFragment final :
 ...
 public:
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_fragment_json(const std::string& value);
...
class QueryContextInformation final :
 ...
 public:
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_default_schema_name(const std::string& value);
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlanFragment::set_fragment_json(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.fragment_json_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PlanFragment::release_fragment_json() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.fragment_json_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void PlanFragment::set_allocated_fragment_json(std::string* fragment_json) {
  ...
  _impl_.fragment_json_.SetAllocated(fragment_json, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.fragment_json_.IsDefault()) {
    _impl_.fragment_json_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlanFragment::set_options_json(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
...
inline void Collector::_internal_add_incoming_minor_fragment(int32_t value) {
  _impl_.incoming_minor_fragment_.Add(value);
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryContextInformation::set_default_schema_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.default_schema_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* QueryContextInformation::release_default_schema_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.default_schema_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void QueryContextInformation::set_allocated_default_schema_name(std::string* default_schema_name) {
  ...
  _impl_.default_schema_name_.SetAllocated(default_schema_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.default_schema_name_.IsDefault()) {
    _impl_.default_schema_name_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryContextInformation::set_session_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
