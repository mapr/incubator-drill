...
PROTOBUF_NAMESPACE_OPEN
template <>
::exec::rpc::Ack* Arena::CreateMaybeMessage<::exec::rpc::Ack>(Arena*);
template <>
::exec::rpc::CompleteRpcMessage* Arena::CreateMaybeMessage<::exec::rpc::CompleteRpcMessage>(Arena*);
template <>
::exec::rpc::RpcHeader* Arena::CreateMaybeMessage<::exec::rpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& RpcMode_Name(RpcMode value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<RpcMode_descriptor,
                                                 0, 4>(
...
class CompleteRpcMessage final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CompleteRpcMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CompleteRpcMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void set_allocated_protobuf_body(std::string* ptr);
  ...
  void set_allocated_raw_body(std::string* ptr);
...
inline ::exec::rpc::RpcHeader* CompleteRpcMessage::_internal_mutable_header() {
  ...
  if (_impl_.header_ == nullptr) {
    auto* p = CreateMaybeMessage<::exec::rpc::RpcHeader>(GetArenaForAllocation());
    _impl_.header_ = p;
  }
...
inline PROTOBUF_ALWAYS_INLINE void CompleteRpcMessage::set_protobuf_body(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.protobuf_body_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void CompleteRpcMessage::_internal_set_protobuf_body(const std::string& value) {
  ...
  _impl_.protobuf_body_.Set(value, GetArenaForAllocation());
}
inline std::string* CompleteRpcMessage::_internal_mutable_protobuf_body() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.protobuf_body_.Mutable( GetArenaForAllocation());
}
...
inline void CompleteRpcMessage::set_allocated_protobuf_body(std::string* value) {
  ...
  _impl_.protobuf_body_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void CompleteRpcMessage::set_raw_body(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.raw_body_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void CompleteRpcMessage::_internal_set_raw_body(const std::string& value) {
  ...
  _impl_.raw_body_.Set(value, GetArenaForAllocation());
}
inline std::string* CompleteRpcMessage::_internal_mutable_raw_body() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.raw_body_.Mutable( GetArenaForAllocation());
}
...
inline void CompleteRpcMessage::set_allocated_raw_body(std::string* value) {
  ...
  _impl_.raw_body_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
