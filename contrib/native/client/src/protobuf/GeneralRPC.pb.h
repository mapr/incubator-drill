...
class CompleteRpcMessage final :
 ...
 public:
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_protobuf_body(const std::string& value);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_raw_body(const std::string& value);
...
void CompleteRpcMessage::set_protobuf_body(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.protobuf_body_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CompleteRpcMessage::release_protobuf_body() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.protobuf_body_.Release();
...
inline void CompleteRpcMessage::set_allocated_protobuf_body(std::string* protobuf_body) {
  ...
  _impl_.protobuf_body_.SetAllocated(protobuf_body, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.protobuf_body_.IsDefault()) {
    _impl_.protobuf_body_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CompleteRpcMessage::set_raw_body(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.raw_body_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CompleteRpcMessage::release_raw_body() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.raw_body_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void CompleteRpcMessage::set_allocated_raw_body(std::string* raw_body) {
  ...
  _impl_.raw_body_.SetAllocated(raw_body, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.raw_body_.IsDefault()) {
    _impl_.raw_body_.Set("", GetArenaForAllocation());
  }
