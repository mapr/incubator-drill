...
inline void FragmentRecordBatch::_internal_add_receiving_minor_fragment_id(int32_t value) {
  _impl_.receiving_minor_fragment_id_.Add(value);
}
...
inline void RuntimeFilterBDef::_internal_add_bloom_filter_size_in_bytes(int32_t value) {
  _impl_.bloom_filter_size_in_bytes_.Add(value);
}
...
inline void RuntimeFilterBDef::set_probe_fields(int index, const char* value, size_t size) {
  _impl_.probe_fields_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline std::string* RuntimeFilterBDef::_internal_add_probe_fields() {
  return _impl_.probe_fields_.Add();
}
